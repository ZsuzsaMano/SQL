...
print("\n6.1 List all the scientists' names, their projects' names and the total hours worked on each project in alphabetical order of project name than scientist name")
